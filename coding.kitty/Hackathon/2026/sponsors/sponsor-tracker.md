---
title: "hack the kitty 2026 — Sponsor Tracker"
date: 2026-05-19
...
- Tom Schelstraete · [tom@aikido.dev](mailto:tom@aikido.dev)
- Sophie Hammel · [sophie@aikido.dev](mailto:sophie@aikido.dev)
...
### 2 · Temporal — Contract Sent

| Field | Detail |
|---|---|
| **HQ** | Washington, USA |
| **Package** | Premium Tier — $3,500 |
| **Status** | Contract sent — awaiting signing |

**Key Contacts**
- Kristin Hillery — Marketing · [kristin.hillery@temporal.io](mailto:kristin.hillery@temporal.io)
- Jason Baum — Developer Advocate · [jason.baum@temporal.io](mailto:jason.baum@temporal.io)

**What they've agreed to**
- Judging support (post-hackathon)
- Discord community session during hackathon

**What they've declined**
- Ongoing mentorship / developer advocate support for the full hackathon duration

> [!NOTE] See [[temporal-request]] for the full support request document sent to Temporal.

**Next Steps**
- [ ] Chase contract signing
- [ ] Confirm judge names and availability for July 8–10
- [ ] Confirm session format and date for their Discord session
...
### 4 · JetBrains — Awaiting Response

| Field | Detail |
|---|---|
| **HQ** | Barcelona, Spain |
| **Status** | Interested — discussing internally |

**Key Contacts**
- Palina Viarbitskaya · [palina@mymeadow.ai](mailto:palina@mymeadow.ai)
- Lidia Saroyan · [lidia@mymeadow.ai](mailto:lidia@mymeadow.ai)

**Notes**
JetBrains are interested but want a **hands-on collaboration** — specifically providing Junie CLI subscription prizes rather than monetary sponsorship. They also want to discuss content/video ideas, as their marketing team only handles contracts that involve content. We've communicated that monetary sponsorship is preferred, and they're discussing internally.

> [!TIP] Potential Prize Sponsor
> If monetary sponsorship doesn't work out, JetBrains could still be a valuable **prize sponsor** — Junie CLI subscriptions are a strong developer-facing prize.

**Next Steps**
- [ ] Await their internal discussion outcome
- [ ] If they come back with a content-only deal, decide whether to accept prizes-only or push for cash
...
| Awaiting Response | No reply yet |
...
- [[temporal-request]] — Full support request document for Temporal
